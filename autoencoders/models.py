...
# 		dec_9 = Flatten(name='dec_flatten')
# 		dec_10 = Dense(input_size, activation='sigmoid', name='dec_dense_2')

# 		self.decoder_layers = lambda x: dec_10(dec_9(dec_8(dec_7(dec_6(dec_5(dec_4(dec_3(dec_2(dec_1(dec_0(x)))))))))))
