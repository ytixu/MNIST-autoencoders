# Taken from https://github.com/eriklindernoren/Keras-GAN/blob/master/aae/aae.py
...
# LeakyReLU_2 = Lambda(lambda x: K.switch(K.greater(x,0), x, x*0.2))
